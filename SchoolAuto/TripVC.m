...
@interface TripVC ()<CLLocationManagerDelegate,UIImagePickerControllerDelegate>
{
...
-(void)addCaptureViewFrom:(NSString *)from{
    ...
    [_caprtureView.layer setShadowOffset:CGSizeMake(0.0, 0.0)];             _caprtureView.center=self.view.center;
}
