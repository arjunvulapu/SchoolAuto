...
@implementation TripsListVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title=@"TRIP LIST'S";
...
-(void)parseResult:(id)result withCode:(int)reqeustCode{
    ...
    if(reqeustCode==109){
        ...
        TripVC *vc =[self.storyboard instantiateViewControllerWithIdentifier:@"TripVC"];
